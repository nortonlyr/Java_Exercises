...
public class E2_21 {
	public static void main(String[] args) {
		...
		double futureValue = futureInvestmentValue(investmentAmount, annualPercentInterestRate, numberOfYears);
		
		System.out.printf("Accumulated value is $%.2f\n", futureValue);
	}
	
	private static double futureInvestmentValue(double amount, double rate, double years) {
