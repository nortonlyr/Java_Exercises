...
public class E3_07 {
	...
	private static String denominationName(int denom, int value) {
		...
		if (value == 0) {
			...
			switch (denom) {
			case 0:
				output.append(value > 1 ? "dollars" : "dollar");
				break;
			case 1:
				output.append(value > 1 ? "quarters" : "quarter");
				break;
			case 2:
				output.append(value > 1 ? "dimes" : "dime");
				break;
			case 3:
				output.append(value > 1 ? "nickels" : "nickel");
				break;
			case 4:
				output.append(value > 1 ? "pennies" : "penny");
				break;
